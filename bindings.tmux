...
is_vim_win="$XDG_CONFIG_HOME/tmux/is_vim_ancestor.sh #{pane_tty}"
 
if-shell 'uname | grep -qE "(MSYS|MINGW|CYGWIN)"' \
    "bind-key -n C-h if-shell \"$is_vim_win\" 'send-keys C-h' 'select-pane -L'" \
    "bind-key -n C-h if-shell \"$is_vim\"     'send-keys C-h' 'select-pane -L'"
 
if-shell 'uname | grep -qE "(MSYS|MINGW|CYGWIN)"' \
    "bind-key -n C-j if-shell \"$is_vim_win\" 'send-keys C-j' 'select-pane -D'" \
    "bind-key -n C-j if-shell \"$is_vim\"     'send-keys C-j' 'select-pane -D'"
 
if-shell 'uname | grep -qE "(MSYS|MINGW|CYGWIN)"' \
    "bind-key -n C-k if-shell \"$is_vim_win\" 'send-keys C-k' 'select-pane -U'" \
    "bind-key -n C-k if-shell \"$is_vim\"     'send-keys C-k' 'select-pane -U'"
 
if-shell 'uname | grep -qE "(MSYS|MINGW|CYGWIN)"' \
    "bind-key -n C-l if-shell \"$is_vim_win\" 'send-keys C-l' 'select-pane -R'" \
